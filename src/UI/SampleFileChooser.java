package UI;// SimpleFileChooser.java
...
public class SampleFileChooser extends JFrame {
    ...
    public SampleFileChooser() {
        ...
        openButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                int option = chooser.showOpenDialog(SampleFileChooser.this);
        ...
        saveButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                JFileChooser chooser = new JFileChooser();
                int option = chooser.showSaveDialog(SampleFileChooser.this);
                if (option == JFileChooser.APPROVE_OPTION) {
    ...
    public static void main(String args[]) {
        SampleFileChooser sfc = new SampleFileChooser();
        sfc.setVisible(true);
    }
}